...
1. **前置檢核：** **🗺️ 劇情大綱規劃師** 必須強制完整讀取以下檔案，以防止源頭出錯：
   * **世界觀底線**：`Story_Bible.md` (故事聖經) 與其他的世界觀設定檔案。這確保大綱一開始就掛上「廢土戰損與色氣」濾鏡。
   * **角色驅動力**：`02_Characters/` 中的角色設定，確保大綱情節符合角色性格與核心動機。
...
1. **✍️ 首席主筆** 嚴格遵循已定案的 `chapter_[X]_plan.md` 與角色設定中的專屬美學，並保持本作的寫作風格（極致的感官描寫、直白露骨的細節與肉體描寫、平民視角），開始逐個節拍 (Beat by Beat) 撰寫初稿。
